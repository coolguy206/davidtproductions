...
<?php } else { ?><?php previous_post_link('%link','Previous Post', false, '5'); ?> | <?php next_post_link('%link', 'Next Post', false, '5'); ?><?php } ?>
...
<?php if(has_category()){ ?>| <i class="fa fa-folder-open-o fa-lg"></i> <?php the_category(); ?><?php } ?> 

<!--check if has tags-->

<?php if(has_tag()){ ?>| <i class="fa fa-tags fa-lg"></i> <?php the_tags(''); ?><?php } ?>
...
<?php previous_post_link('%link','Previous Post', false, '5'); ?> | <?php next_post_link('%link', 'Next Post', false, '5'); ?><?php } ?>
